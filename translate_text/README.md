...
* Download the [mega-pipeline.json](https://canvas.harvard.edu/files/23163432/download?download_frd=1) and save it inside a folder called `secrets` inside `translate_text`
